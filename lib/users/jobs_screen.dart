            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.symmetric(
                    horizontal: isWeb ? 80 : 16, vertical: 16),
                child: Align(
...
class _HoverJobCardState extends State<_HoverJobCard> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget card = AnimatedContainer(
      ...
      transform:
          _isHovered && isWeb ? (Matrix4.identity()..scale(1.05)) : Matrix4.identity(),
...
class JobsCategoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      "IT Jobs": [
        {
          ...
          "salary": "₹10 - 15 LPA",
          "type": "Full-time",
          "description": "Develop mobile applications using Flutter and Dart, Develop mobile applications using Flutter and Dart, Develop mobile applications using Flutter and Dart., Develop mobile applications using Flutter and Dart. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
        },
        {
    ...
    return Scaffold(
      ...
      body: Padding(
        padding: EdgeInsets.symmetric(horizontal: isWeb ? 80 : 16, vertical: 16),
        child: GridView.builder(
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
...
class _HoverJobCardCategory extends StatefulWidget {
  ...
  const _HoverJobCardCategory(
      {required this.job, required this.isWeb, required this.onTap});
...
class _HoverJobCardCategoryState extends State<_HoverJobCardCategory> {
  ...
  Widget build(BuildContext context) {
    Widget card = AnimatedContainer(
      duration: const Duration(milliseconds: 200),
      transform:
          _isHovered && widget.isWeb ? (Matrix4.identity()..scale(1.03)) : Matrix4.identity(),
      decoration: BoxDecoration(
        color: Colors.white,
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 120), // leave space for button
                        ],
                      ),
                    ),
                  ),
      ...
      child: Container(
        ...
        child: ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: _isHovered ? AppColors.primary.withOpacity(0.8) : AppColors.primary,
