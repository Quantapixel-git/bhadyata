    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        padding: EdgeInsets.symmetric(
          horizontal: isWeb ? MediaQuery.of(context).size.width * 0.2 : 16,
          vertical: 20,
        ),
        child: Column(
          ...
          children: [
              ...
              child: Column(
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: const AssetImage("assets/job_bgr.png"), // your placeholder image
                  ),
            ...
            _infoTile(Icons.school, "B.Tech in Computer Science", "XYZ University, 2018 – 2022"),
            _infoTile(Icons.menu_book, "12th - CBSE", "ABC Public School, 2018"),

            const SizedBox(height: 20),

            // 🔹 Experience
            _sectionTitle("Work Experience"),
            _infoTile(Icons.business_center, "Software Developer", "Google India • 2022 – Present"),
            _infoTile(Icons.business_center, "Intern - Flutter Developer", "TechNova • Jan 2022 – Jun 2022"),
