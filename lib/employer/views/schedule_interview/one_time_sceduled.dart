...
class employerOneTimeApplicantsPage extends StatefulWidget {
  final int jobId;
  final String? jobTitle;

  const employerOneTimeApplicantsPage({
    super.key,
    required this.jobId,
    this.jobTitle,
  });
  ...
  @override
  State<employerOneTimeApplicantsPage> createState() =>
      _employerOneTimeApplicantsPageState();
}

class _employerOneTimeApplicantsPageState
    extends State<employerOneTimeApplicantsPage> {
  bool _loading = true;
  String? _error;
  ...
  final String _updateStatusUrl =
      'https://dialfirst.in/quantapixel/badhyata/api/updateApplicantStatus';
