// lib/employer/views/jobs/employer_onetime_jobs_with_applicants.dart
import 'dart:convert';
...
import 'package:jobshub/employer/views/schedule_interview/one_time_sceduled.dart';
import 'package:jobshub/employer/views/sidebar_dashboard/employer_sidebar.dart';

class EmployerOneTimeJobsWithApplicantsPage extends StatefulWidget {
  const EmployerOneTimeJobsWithApplicantsPage({super.key});

  @override
  State<EmployerOneTimeJobsWithApplicantsPage> createState() =>
      _EmployerOneTimeJobsWithApplicantsPageState();
}

class _EmployerOneTimeJobsWithApplicantsPageState
    extends State<EmployerOneTimeJobsWithApplicantsPage> {
  bool _loading = true;
  String? _error;
  List<Map<String, dynamic>> _jobs = [];

  // API endpoint (matches your controller route)
  final String apiUrl = '${ApiConstants.baseUrl}oneTimeJobsWithApplicants';
  ...
  int _extractJobId(Map<String, dynamic> job) {
    final raw = job['id'] ?? job['job_id'] ?? job['jobId'];
                    ...
                    child: _jobs.isEmpty
                        ? ListView(
                            ...
                            children: [
                              ...
                              Center(
                                child: Text(
                                  'No one-time jobs with applicants',
                                  style: TextStyle(
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, i) {
                              ...
                              // Payment: prefer payment_amount; fallback to other fields if present
                                ...
                                child: ListTile(
                                  ...
                                  subtitle: Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: 2),
                                      Text(
                                        "Date: $jobDate ${startTime != '—' ? '• $startTime' : ''}${endTime != '—' ? ' – $endTime' : ''}",
                                      ),
                                      const SizedBox(height: 8),
                                  ...
                                  trailing: IconButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      // Navigate to the one-time applicants page.
                                      // Replace `EmployerOneTimeApplicantsPage` with the actual applicants page class you have.
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (_) =>
                                              employerOneTimeApplicantsPage(
                                                jobId: jobId,
                                                jobTitle: title,
                                              ),
                                        ),
