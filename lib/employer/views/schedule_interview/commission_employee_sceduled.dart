...
class employerCommissionBasedApplicantsPage extends StatefulWidget {
  final int jobId;
  final String? jobTitle;

  const employerCommissionBasedApplicantsPage({
    super.key,
    required this.jobId,
    this.jobTitle,
  });
  ...
  @override
  State<employerCommissionBasedApplicantsPage> createState() =>
      _employerCommissionBasedApplicantsPageState();
}

class _employerCommissionBasedApplicantsPageState
    extends State<employerCommissionBasedApplicantsPage> {
  bool _loading = true;
  String? _error;
  ...
  final String _updateStatusUrl =
      'https://dialfirst.in/quantapixel/badhyata/api/updateStatusCommissionBased';
