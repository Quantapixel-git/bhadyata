// lib/hr/views/job_applicants/salary_job_applicants.dart
// Uploaded image (local path): sandbox:/mnt/data/2643eb78-a484-4ed7-891d-f2e6eb195ec0.png
...
class employerSalaryBasedApplicantsPage extends StatefulWidget {
  final int jobId;
  final String? jobTitle;

  const employerSalaryBasedApplicantsPage({
    super.key,
    required this.jobId,
    this.jobTitle,
  });
  ...
  @override
  State<employerSalaryBasedApplicantsPage> createState() =>
      _employerSalaryBasedApplicantsPageState();
}

class _employerSalaryBasedApplicantsPageState
    extends State<employerSalaryBasedApplicantsPage> {
  bool _loading = true;
  String? _error;
  ...
  final String _updateStatusUrl =
      'https://dialfirst.in/quantapixel/badhyata/api/updateStatusSalayBased';
  ...
  Future<void> _fetchApplicants() async {
    ...
    try {
      ...
      final res = await http.post(
        ...
        body: jsonEncode({"job_id": widget.jobId, "hr_approval": 1}),
      );
                                      ...
                                      child: AnimatedContainer(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            // bottom action row:
                                            // Left: HR pill, Right: row of actions (status picker, view profile)
                                            Padding(
                                              padding:
                                                  const EdgeInsets.symmetric(
                                                    horizontal: 14.0,
                                                  ...
                                                  if (rowLoading)
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        // View profile (navigate to internal profile page)
                                                      ],
                                                    ),
                                                ],
                                              ),
