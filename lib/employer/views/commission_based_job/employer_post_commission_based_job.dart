...
class _EmployerPostCommissionBasedJobState
  ...
  final TextEditingController _potentialEarningsController = TextEditingController();
  ...
  Future<void> _postCommissionBasedJob() async {
    ...
    print("🔹 Starting commission-based job post process...");
    ...
    try {
      ...
      final body = {
        ...
        "potential_earning": double.tryParse(_potentialEarningsController.text) ?? 0,
      ...
      if ((response.statusCode == 200 || response.statusCode == 201) &&
          data["success"] == true) {
        print("✅ Commission-based Job posted successfully!");
        ...
        print("❌ Failed to post commission-based job. Message: ${data['message']}");
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            behavior: SnackBarBehavior.floating,
      ...
      print("🔥 Exception occurred while posting commission-based job: $e");
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          behavior: SnackBarBehavior.floating,
      ...
      print("🏁 Commission-based job post process completed.");
    }
  }
