...
class EmployerCompleteProfile extends StatefulWidget {
  final String mobile;

  const EmployerCompleteProfile({super.key, required this.mobile});

  @override
  State<EmployerCompleteProfile> createState() =>
      _EmployerCompleteProfileState();
}

class _EmployerCompleteProfileState extends State<EmployerCompleteProfile> {
  ...
  Future<void> _signUp() async {
    ...
    try {
      ...
      request.fields['role'] = '2'; // ✅ Employer Role
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: const [
                                  ...
                                  SizedBox(height: 12),
                                  Text(
                                    "Create your employer profile and start hiring top talent effortlessly.",
                                    style: TextStyle(
                                      fontSize: 16,
