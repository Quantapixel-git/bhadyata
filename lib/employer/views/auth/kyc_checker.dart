...
class EmployerKyccheckerPage extends StatefulWidget {
  const EmployerKyccheckerPage({super.key});

  @override
  State<EmployerKyccheckerPage> createState() => _EmployerKyccheckerPageState();
}

class _EmployerKyccheckerPageState extends State<EmployerKyccheckerPage> {
