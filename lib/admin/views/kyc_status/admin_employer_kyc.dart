...
class EmployerKYCPage extends StatefulWidget {
  const EmployerKYCPage({super.key});

  @override
  State<EmployerKYCPage> createState() => _EmployerKYCPageState();
}

class _EmployerKYCPageState extends State<EmployerKYCPage> {
  // API config
  static const String _baseApi =
      'https://dialfirst.in/quantapixel/badhyata/api/'; // provided
  static const String _profilesPath = 'EmployerProfilesAll';
  static const String _kycStatusPath = 'EmployerKycStatus';
  ...
  Future<void> _fetchPage({int page = 1}) async {
    ...
    final Map<String, dynamic> bodyMap = {
      'page': page,
      'per_page': _perPage,
      'role': 2, // keep role filter as requested
    };
