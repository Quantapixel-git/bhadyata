                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final employers = recips
                          ...
                          .toList();
                      // treat any role containing 'hr' as HR
                      final hrs = recips
                          .where(
                            (r) => (r["role"]?.toString().toLowerCase() ?? "")
                                .contains("hr"),
...
class NotificationRecipientsPage extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> hrs;
        ...
        child: Scaffold(
          ...
          body: TabBarView(
            children: [
              ...
              _RecipientList(
                items: hrs,
                emptyText: "No HRs received this notification.",
                icon: Icons.badge,
                color: Colors.orange,
              ),
            ],
