...
class SalaryBasedApplicantsPage extends StatefulWidget {
  final int jobId;
  final String? jobTitle;

  const SalaryBasedApplicantsPage({
    super.key,
    required this.jobId,
    this.jobTitle,
  });
  ...
  @override
  State<SalaryBasedApplicantsPage> createState() =>
      _SalaryBasedApplicantsPageState();
}

class _SalaryBasedApplicantsPageState extends State<SalaryBasedApplicantsPage> {
  bool _loading = true;
  String? _error;
  ...
  final String _fetchUrl =
      'https://dialfirst.in/quantapixel/badhyata/api/salarybasedApplicantsByJob';
  final String _updateHrApprovalUrl =
      'https://dialfirst.in/quantapixel/badhyata/api/updateHrApprovalSalayBased';
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              ...
              action: SnackBarAction(
                label: 'Undo',
                onPressed: () {
                  // local revert only (server-side undo requires another API)
                                  ...
                                  child: MouseRegion(
                                    ...
                                    child: Material(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () {
                                          // quick preview (keeps right side clean)
                                        },
                                        child: AnimatedContainer(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              // bottom action row (Approve / Reject / View) - aligned right on wide screens
                                              Padding(
                                                padding:
                                                    const EdgeInsets.symmetric(
                                                      horizontal: 14.0,
