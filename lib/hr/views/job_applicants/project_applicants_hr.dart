...
class ProjectApplicantsPage extends StatefulWidget {
  final int
  jobId; // kept name same as SalaryBasedApplicantsPage for easy swap-in
  final String? jobTitle;

  const ProjectApplicantsPage({super.key, required this.jobId, this.jobTitle});
...
class _ProjectApplicantsPageState extends State<ProjectApplicantsPage> {
  ...
  final String _updateHrApprovalUrl =
      'https://dialfirst.in/quantapixel/badhyata/api/updateHrApprovalProject';
  ...
  Future<void> _fetchApplicants() async {
    ...
    try {
      final res = await http.post(
        ...
        body: jsonEncode({"project_id": widget.jobId}),
      );
                                        ...
                                        child: AnimatedContainer(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              // bottom action row (Approve / Reject / View)
                                              Padding(
                                                padding:
                                                    const EdgeInsets.symmetric(
                                                      horizontal: 14.0,
                                                        ...
                                                        children: [
                                                          ...
                                                          IconButton(
                                                            tooltip:
                                                                'View profile',
                                                            onPressed: () {
                                                              // Navigator.push(...) to view profile if needed
                                                            },
                                                            icon: Icon(
                                                              Icons
                                                                  .remove_red_eye,
