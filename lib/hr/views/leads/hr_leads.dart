...
/// HrLeadsPage => shows list of employees (with lead counts).
/// Tapping an employee opens EmployeeHrLeadsPage (detail) which shows their leads.
/// UI-only: uses in-memory mock data (same as before), with debug prints.

class HrLeadsPage extends StatefulWidget {
  const HrLeadsPage({super.key});

  @override
  State<HrLeadsPage> createState() => _HrLeadsPageState();
}

class _HrLeadsPageState extends State<HrLeadsPage> {
  bool _loading = true;
  String? _error;
  ...
  void initState() {
    super.initState();
    print("INIT: HrLeadsPage (employees list)"); // DEBUG LOG
    _loadMockData();
  }
  ...
  Widget build(BuildContext context) {
    print(
      "BUILD: HrLeadsPage (list) employees=${_employees.length}",
    ); // DEBUG LOG
      ...
      builder: (context, constraints) {
        ...
        return HrDashboardWrapper(
          child: Scaffold(
            ...
            drawer: isWeb ? null : const HrSidebar(),
            body: Container(
                                ...
                                child: ListTile(
                                  onTap: () {
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (_) =>
                                            EmployeeHrLeadsPage(employee: e),
                                      ),
                                    );
                                  },
...
/// EmployeeHrLeadsPage — shows list of leads for passed employee map.
/// Mutations (status updates / conversion) modify the passed employee's leads in memory.
class EmployeeHrLeadsPage extends StatefulWidget {
  final Map<String, dynamic> employee;
  const EmployeeHrLeadsPage({required this.employee, super.key});

  @override
  State<EmployeeHrLeadsPage> createState() => _EmployeeHrLeadsPageState();
}

class _EmployeeHrLeadsPageState extends State<EmployeeHrLeadsPage> {
