...
class HrKyccheckerPage extends StatefulWidget {
  const HrKyccheckerPage({super.key});

  @override
  State<HrKyccheckerPage> createState() => _HrKyccheckerPageState();
}

class _HrKyccheckerPageState extends State<HrKyccheckerPage> {
